...
public class DoublyLinkedList<E> implements Serializable {
     ...
     * @throws IndexOutOfBoundsException if the index p is outside the range 0 to <code>length - 1</code>.
     */
     ...
     * @throws IndexOutOfBoundsException if <code>p</code> is outside the range 0 to length()</code>
     */
